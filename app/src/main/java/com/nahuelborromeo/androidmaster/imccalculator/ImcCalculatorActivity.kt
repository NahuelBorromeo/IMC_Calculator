...
class ImcCalculatorActivity : AppCompatActivity() {
    ...
    private var minimumWeight: Int = 1
    private var maximumWeight: Int = 250
    private var currentAge: Int = 18
    private var minimunAge: Int = 1
    private var maximumAge: Int = 100
    private var currentHeight: Int = 120

    //lateinit iniciará cuando yo le diga, se usa para poder usarlo en todos los métodos
    ...
    private fun initListeners() {
        viewMale.setOnClickListener {
            if (!isMaleSelected) changeGender()
            setGenderColor()
        }
        viewFemale.setOnClickListener {
            if (!isFemaleSelected) changeGender()
            setGenderColor()
        }
    ...
    private fun setAge() {
        tvAge.text = "${currentAge.toString()} years"
    }
